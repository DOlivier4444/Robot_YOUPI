bool Validate_Move(int motor_id, int rotation, int coders_motors[]) {
  ...
  switch (motor_id) {
    ...
    case MOTOR_2:  // MOTOR_2 - epaule
      ...
      return (
        (rotation == FORWARD
        && coders_motors[MOTOR_2] <= motor_limits[1][0]
        && (coders_motors[MOTOR_2] + coders_motors[MOTOR_3]) <= motor_limits[2][0]) 
        || (rotation == BACKWARDS
        && coders_motors[MOTOR_2] >= motor_limits[1][1]
        && (coders_motors[MOTOR_2] + coders_motors[MOTOR_3]) >= motor_limits[2][1])
      );
    ...
    case MOTOR_3:  // MOTOR_3 - coude
      ...
      return (
        (rotation == FORWARD
        && (coders_motors[MOTOR_2] + coders_motors[MOTOR_3]) <= motor_limits[2][0]
        && (coders_motors[MOTOR_4] + coders_motors[MOTOR_3]) <= motor_limits[3][0])
        ||
        (rotation == BACKWARDS
        && (coders_motors[MOTOR_2] + coders_motors[MOTOR_3]) >= motor_limits[2][1]
        && (coders_motors[MOTOR_4] + coders_motors[MOTOR_3]) >= motor_limits[3][1])
      );
    ...
    case MOTOR_4:  // MOTOR_4 - poignet
      ...
      return (
        ...
        && (coders_motors[MOTOR_4] + coders_motors[MOTOR_3]) <= motor_limits[3][0])
        ||
        (rotation == BACKWARDS && (coders_motors[MOTOR_4] + coders_motors[MOTOR_3]) >= motor_limits[3][1])
      );
    ...
    case MOTOR_6:  // MOTOR_6 - Actuator
      ...
      return (
        (rotation == FORWARD
        && coders_motors[MOTOR_6] <= motor_limits[5][0])
        ||
        (rotation == BACKWARDS
        && coders_motors[MOTOR_6] >= motor_limits[5][1])
      );
