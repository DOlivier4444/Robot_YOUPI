...
def moteur_2() : #épaule
	...
	global sens_rotation, Codeur_moteur2, Codeur_moteur3
	if (sens_rotation == 1) and (Codeur_moteur2 <= 4500-1) and ((Codeur_moteur2 + Codeur_moteur3) <= 3200-1):
		rotation_moteur_2()
		Codeur_moteur2 += 1
	if (sens_rotation == 0) and (Codeur_moteur2 >= -2400+1) and ((Codeur_moteur2 + Codeur_moteur3) >= -4500+1):
		rotation_moteur_2()
		Codeur_moteur2 -= 1
...
def moteur_3() : #coude
	...
	global sens_rotation, Codeur_moteur3, Codeur_moteur2, Codeur_moteur4
...
def moteur_5() : #rotation main
	...
	global sens_rotation, Codeur_moteur5
	if sens_rotation == 1:
		rotation_moteur_5()
		Codeur_moteur5 += 1
	if sens_rotation == 0:
...
#	global variables
	...
	global sens_rotation, vitesse_manu
